...
class TestKDTree:
    ...
    def test_query(self, k: int, selection_size: int, dimension: int, leaf_size: int):
        ...
        X_test = self._generate_selection(int(selection_size * self.TEST_PART), dimension)
    ...
    def test_k_nearest_neighbours(self, k: int, selection_size: int, dimension: int, leaf_size: int):
        X_train = self._generate_selection(selection_size, dimension)
